import { IReprovacaoRecrutamentoSolicitanteData } from '../../interfaces/IEmailTemplates';

export function reprovacaoSolicitante(
  data: IReprovacaoRecrutamentoSolicitanteData,
): string {
  return `
<!doctype html>
<html lang="pt-BR">
  <head>
    ...
    <title>Solicitação de Recrutamento Reprovada</title>
  </head>
  <body
    style="
      margin: 0;
            ...
            <tr>
              <td style="padding: 28px 32px">
                ...
                <p
                  ...
                  "
                >
                  Sua solicitação de recrutamento foi reprovada.
                </p>
